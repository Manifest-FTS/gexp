...
import { GalaIcon } from '../icons/gala';
import MyNFTFeeds from '../search/my-nft-feed';
  ...
  return (
    <>
      <div className="mx-auto w-full sm:pt-0 lg:px-8 xl:px-10 2xl:px-0">
        {/* Title Preview  */}
        <div className="mb-6 grid grid-cols-2 gap-12 sm:mb-10">
        ...
        <div className="mb-8 grid grid-cols-1 gap-12 lg:grid-cols-1">
          {/* Left Side */}
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <InputLabel
                ...
                subTitle="Sell for crypto or barter (swap) for other NFTs."
              />
            ...
            <div className="my-6 items-center justify-between gap-4">
              <InputLabel
                title="Select NFTs"
                subTitle="Select 1 or more NFTs to sell or barter (swap)."
              />
              <MyNFTFeeds />
            </div>
            ...
            <div className="my-8">
              <InputLabel
                title="Comments"
                subTitle="Will be included on the item's detail page underneath its image."
              />
              <Textarea placeholder="Add a personal touch! Include any additional information, NFT stats, or messages you'd like to share with potential buyers or traders about your NFT. No links or contact information please." />
            </div>
            ...
            <div className="my-8">
              ...
              <div className="flex items-center rounded-md px-3 py-2 text-sm text-gray-900 bg-gray-200/70 font-medium">
